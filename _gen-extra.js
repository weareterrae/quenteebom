...
const META = {
  ...
  'tranca-doce-de-brioche':               { cat: 'Bolos',      tags: ['Bolos', 'Festa'] },
...
const RECEITAS = [
  ...
  {
    slug: 'tranca-doce-de-brioche', titulo: 'Trança Doce de Brioche',
    img: '/assets/img/rec_trancabrioche.webp',
    tempo: '3h (com levedação)', dif: 'Média', rende: '1 trança grande',
    intro: 'Uma trança de brioche fofa e dourada, perfumada a laranja, para o pequeno-almoço de domingo. A nossa Farinha Brioche facilita todo o trabalho da massa.',
    produtos: [['Farinha Brioche', '/cakes/'], ['Sultanas', '/ingredientes/']],
    ingredientes: [
      '<b><a href="/cakes/">Farinha Brioche</a> Quente e Bom</b> — preparada segundo as proporções da embalagem (ovos, leite morno e manteiga)',
      'Raspa de 1 laranja',
      '<b><a href="/ingredientes/">Sultanas</a> Quente e Bom</b> — 80 g (opcional)',
      '1 gema + um pouco de leite (para pincelar)',
      'Açúcar em grão para polvilhar',
    ],
    passos: [
      ['Massa', 'Prepara a massa de brioche conforme a embalagem da Farinha Brioche, juntando a raspa de laranja e as sultanas. Amassa até ficar lisa e elástica.'],
      ['Leveda', 'Tapa e deixa levedar em lugar morno até dobrar de volume (±1h30).'],
      ['Trança', 'Divide em 3 rolos e faz uma trança. Coloca no tabuleiro e deixa levedar mais 30 minutos.'],
      ['Pincela e coze', 'Pincela com gema e leite, polvilha com açúcar em grão e coze a 180 °C 25–30 minutos, até dourada. 🥯'],
    ],
    dicaBento: 'Segue as proporções da embalagem da Farinha Brioche à risca — e dá tempo à levedação, que é ela que faz o fofo. ☀️',
  },
  {
  ...
  {
    slug: 'mousse-de-maracuja', titulo: 'Mousse de Maracujá',
    img: '/assets/img/rec_maracuja.webp',
    tempo: '15 min + frio', dif: 'Muito fácil', rende: '6 taças',
    intro: 'Fresca, ácida na medida certa e cremosa: a mousse de maracujá que se faz em 15 minutos com o nosso Chantilly em Pó. Sabor tropical que refresca qualquer dia de calor.',
    produtos: [['Chantilly em Pó', '/ingredientes/']],
    ingredientes: [
      '<b><a href="/ingredientes/">Chantilly em Pó</a> Quente e Bom</b> — 200 g',
      '330 ml de leite bem frio',
      '1 lata de leite condensado',
      'Polpa de 4 maracujás (guarda as sementes de 1 para decorar)',
    ],
    passos: [
      ['Chantilly', 'Bate o Chantilly em Pó com o leite frio 4–5 minutos na máxima, até firme.'],
      ['Creme', 'À parte, mistura o leite condensado com a polpa de maracujá coada.'],
      ['Envolve', 'Junta o creme de maracujá ao chantilly, envolvendo com suavidade de baixo para cima.'],
      ['Frio', 'Divide por taças, leva ao frio 3 horas e decora com as sementes de maracujá. 💛'],
    ],
    dicaBento: 'Coa a polpa para a mousse (guarda umas sementes para decorar) — fica sedosa e com o brilho do maracujá por cima. ☀️',
  },
  {
  ...
  },
  {
    ...
    intro: 'A sobremesa quente mais rápida e angolana que há: banana caramelizada na manteiga e açúcar, com o crocante do nosso Caju Torrado. Sobre uma bola de gelado, é divinal.',
    produtos: [['Caju Torrado', '/snacks/']],
    ingredientes: [
      '4 bananas maduras (mas firmes), aos meios',
      '2 colheres de sopa de manteiga',
      '3 colheres de sopa de açúcar (mascavado fica melhor)',
      '<b><a href="/snacks/">Caju Torrado</a> Quente e Bom</b> — 60 g, picado',
      'Canela e uma bola de gelado (opcional)',
    ],
    passos: [
      ['Derrete', 'Derrete a manteiga com o açúcar numa frigideira até formar um caramelo.'],
      ['Caramela', 'Coloca as bananas com o corte para baixo e deixa caramelizar 2 minutos de cada lado.'],
      ['Caju', 'Junta o caju picado e uma pitada de canela, envolvendo no caramelo.'],
      ['Serve', 'Serve quente, sozinho ou sobre gelado de baunilha, com o caramelo por cima. 🍌✨'],
    ],
    dicaBento: 'Banana madura mas ainda firme aguenta a frigideira sem se desfazer — e o caju torrado dá o crocante que faltava. ☀️',
  },
  {
  ...
  {
    slug: 'mousse-de-manga', titulo: 'Mousse de Manga',
    img: '/assets/img/rec_moussemanga.webp',
    tempo: '15 min + frio', dif: 'Muito fácil', rende: '6 taças',
    intro: 'Puro sol de Angola numa taça: a doçura da manga madura numa mousse leve e cremosa, feita em minutos com o nosso Chantilly em Pó. Sem forno, só frescura.',
    produtos: [['Chantilly em Pó', '/ingredientes/']],
    ingredientes: [
      '<b><a href="/ingredientes/">Chantilly em Pó</a> Quente e Bom</b> — 200 g',
      '330 ml de leite bem frio',
      '2 mangas maduras (polpa) + extra para decorar',
      '1 lata de leite condensado · sumo de meio limão',
    ],
    passos: [
      ['Chantilly', 'Bate o Chantilly em Pó com o leite frio 4–5 minutos até firme.'],
      ['Manga', 'Tritura a polpa de manga com o leite condensado e o sumo de limão até um creme liso.'],
      ['Envolve', 'Junta o creme de manga ao chantilly, envolvendo com suavidade.'],
      ['Frio', 'Divide por taças, leva ao frio 3 horas e decora com cubinhos de manga. 🥭'],
    ],
    dicaBento: 'O limão equilibra a doçura da manga e realça o aroma — usa manga bem madura, dessas que perfumam a cozinha. ☀️',
  },
  {
